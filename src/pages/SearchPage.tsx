...
const SearchPage: React.FC = () => {
  ...
  const { filters, filteredItems: filteredResults, handleFilterChange } = useMediaFiltering(results, initialFilters);
  ...
  useEffect(() => {
    ...
    const performSearch = async () => {
      ...
      try {
        ...
        setTotalPages(data.total_pages > 0 ? Math.min(data.total_pages, 20) : 0); // Limit to 20 pages max
      } catch (err) {
  ...
  return (
    <div className="pb-20">
      ...
      <div className="mb-6">
        <SearchBar placeholder="Rechercher films et séries..." />
      </div>
